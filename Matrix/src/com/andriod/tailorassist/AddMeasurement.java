...
//        setContentView(R.layout.activity_measurements); 
        Ctxt = this;
        //testing changes
        Button btnSaveMeasurement = (Button) findViewById(R.id.save_btn);
    ...
    public long addCustomerDetails(View view){    	
    	...
    	long newCustNo = 0;
//    	String custShirt = ((EditText)findViewById(R.id.editText_measurement)).getText().toString();    	
//    	String custPant = ((EditText)findViewById(R.id.editText_measurement)).getText().toString();;
...
//    	}
   ...
   /* public void btnSmIn(View view) {
    ...
    public void editTextClicked(View v){
    	...
    	if(idEditText==R.id.editText_measurement){
